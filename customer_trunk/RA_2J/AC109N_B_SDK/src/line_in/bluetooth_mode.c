...
{
#ifndef BLUE_TOOTH_DONT_TURN_ON_LED			
...
void bluetooth_end_hdlr(void) AT(LINE_IN_CODE)
{
    ...
    ext_pa_mute(PA_MUTE);  
#ifdef BLUE_TOOTH_MODE_END_FORCE_DISCONNECT 
    bluetooth_promt_msg_hdlr(MSG_BT_REPAIRING);
    delay_n10ms(10);
#endif
...
#ifndef BLUE_TOOTH_PWER_ON_DELAY_MUTE_DISABLE
...
#ifdef BLUE_TOOTH_NEXT_PREV_POPNOISE_DELAY_HANDLE
        case MSG_MUSIC_NEXT_FILE:
    		activate_pop_noise_hdlr(MS_1000);
		break;
