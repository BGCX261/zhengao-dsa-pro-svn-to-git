...
#define iic_data_out()    	P0DIR &= ~(BIT(7));P0PU |= BIT(7) 	
#define iic_data_in()     	P0DIR |= (BIT(7));P0PU |= BIT(7)	
#define iic_data_r()      	P07
#define iic_data_h()      	P07 = 1
#define iic_data_l()      	P07 = 0

#define iic_clk_out()    	P0DIR &= ~(BIT(6));P0PU |= (BIT(6))
#define iic_clk_h()      	P06 = 1
#define iic_clk_l()      		P06 = 0
#if 0
/*
