...
#ifdef CUSTOM_DEFINED_PATH
#define DAC_DECODER_PATH	DAC_DECODER
#define DAC_RADIO_PATH		DAC_AMUX1
#define DAC_AUX_PATH		DAC_AMUX1
#define DAC_BT_PATH		DAC_DECODER
#define DAC_IPOD_PATH		DAC_AMUX1
#elif defined(CUSTOM_DEFINED_PATH_AUX_AT_P24P25_RADIO_AT_P26P27)
#define DAC_DECODER_PATH	DAC_DECODER
#define DAC_RADIO_PATH		DAC_AMUX1
#define DAC_AUX_PATH		DAC_AMUX0
#define DAC_BT_PATH		DAC_AMUX1
#define DAC_IPOD_PATH		DAC_AMUX1
#else
#define DAC_DECODER_PATH	DAC_DECODER
#define DAC_RADIO_PATH		DAC_AMUX0
#define DAC_AUX_PATH		DAC_AMUX1
#define DAC_BT_PATH		DAC_AMUX1
#define DAC_IPOD_PATH		DAC_AMUX1
#endif
