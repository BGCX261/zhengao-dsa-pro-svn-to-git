...
#ifdef RA_2K_1090A_V001
#define FM_BAND_TOP			1080
#define FM_BAND_BOTTOM		875
#else
#define FM_BAND_TOP			900
#define FM_BAND_BOTTOM		760
#endif
...
signed char  KT_FM_GetAFC(void);
signed char  KT_AM_GetAFC(void);
...
bool KT_FM_ValidStation(u16 iFrequency);
bool KT_AM_ValidStation(u16 iFrequency);
