...
#define AD_NOKEY			(0xFA00)

#else

#define ADKEY1_8			0x1000
#define ADKEY1_7			0x3000	
#define ADKEY1_6			0x5000	
#define ADKEY1_5			0x7000
#define ADKEY1_4			0x9000
#define ADKEY1_3			0xB000
#define ADKEY1_2			0xD000
#define ADKEY1_1			(0xFA00)
#define ADKEY1_0			(0xFA00)
#define AD_NOKEY			(0xFA00)
