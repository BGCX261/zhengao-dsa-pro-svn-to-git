...
#define AD_ERROR_VAL		(0x8540-0x67c0)/2+0x67c0
#define AD_AUX_VAL			(0x66c0-0x4ac0)/2+0x4ac0
#define AD_MW_VAL			(0x49c0-0x3740)/2+0x3740
#define AD_FM_VAL			(0x3700-0x1e80)/2+0x1e80
#define AD_MUSIC_VAL		(0x1e40-0x0)/2+0x0
#endif
