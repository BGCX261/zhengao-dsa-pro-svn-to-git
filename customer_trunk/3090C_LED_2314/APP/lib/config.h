...
#define REC_CHAN_PORT_INIT() 	 			P0DIR &= ~(BIT(1));P0PU &= ~BIT(1);P0PD &= ~BIT(1)
#define REC_CHAN_PORT_DISABLE() 	 		P01 = 0
#define REC_CHAN_PORT_ENABLE() 	 		P01 = 1


#define MAIN_POWER_PORT_INIT() 	 		P1DIR &= ~(BIT(7));P1PU &= ~BIT(7);P1PD &= ~BIT(7)
#define MAIN_POWER_PORT_DISABLE() 	 	P17 = 1
#define MAIN_POWER_PORT_ENABLE() 	 		P17 = 0
//显示屏选择
