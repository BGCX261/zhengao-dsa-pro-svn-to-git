...
#ifdef LED_GPIO_PORT_CUSTOMERIZED
#ifdef UI_FADE_EN
#undef UI_FADE_EN
#endif
#endif
...
#if defined RDA5807 || defined BK1080 || defined KT0830EG || defined QN8035 || defined AR1019|| defined KT_AMFM
#define RADIO_MODE_ENABLE           //FM 模式开关
#endif

#ifdef NO_FM_CHIP_ON_BOARD
#ifdef RADIO_MODE_ENABLE  
#undef RADIO_MODE_ENABLE  
#endif
#endif
//---------------------------------------------------------------------------------------------------------------/
...
#ifndef MUSIC_BREAK_POINT_INFO_FUNC
