...
extern xd_u8 disk_toc_ok,dev_invalid,dev_init_read;
...
u8 _code DSA_Key[][3]={
  ...
  {0x55,0x1A,(MSG_MUSIC_REP_OFF)},
  {0x55,0x1B,(MSG_MUSIC_REP_ONE)},
  {0x55,0x1C,(MSG_MUSIC_REP_ALL)},
 };
