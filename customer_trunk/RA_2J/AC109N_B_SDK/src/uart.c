...
#ifdef UART_DEBUG_AT_P06P07
    P0DIR &= 0xBF;							/* P06 for transmit */
    P0DIR |= 0x80;							/* P07 for receive */
#elif defined(UART_DEBUG_AT_P24P25)    
    P2DIR &= ~BIT(4);
    P2DIR |= BIT(5);
    IO_MC0 |= BIT(6);
#elif defined(UART_DEBUG_AT_P32P33)    
    P3DIR &= ~BIT(2);
    P3DIR |= BIT(3);
    IO_MC0 |= BIT(7);
#elif defined(UART_DEBUG_AT_P36P37)    
    USB_CON0 = 0x11;
    USB_CON2 &= ~BIT(1);
    P3DIR &= ~BIT(6);
    P3DIR |= BIT(7);
