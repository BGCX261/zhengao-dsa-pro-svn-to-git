...
#elif defined(PLAY_STATUS_LED_P16)
#define LED_PORT_BIT		6
#define led_port_init()		P1DIR &=~(BIT(LED_PORT_BIT));P1PU |= BIT(LED_PORT_BIT);
#define led_set_port_on()		P16=ON_LEVEL
#define led_set_port_off()		P16=OFF_LEVEL
...
#define LED_PORT_BIT		5
#define led_port_init()		P0DIR &=~(BIT(LED_PORT_BIT));P0PU |= BIT(LED_PORT_BIT);
#define led_set_port_on()		P05=ON_LEVEL
#define led_set_port_off()		P05=OFF_LEVEL
...
#elif defined(PLAY_STATUS_ID2_LED_P05)
#define LED_ID2_PORT_BIT		5
#define led_id2_port_init()		P0DIR &=~(BIT(LED_ID2_PORT_BIT));P0PU |= BIT(LED_ID2_PORT_BIT);
#define led_id2_set_port_on()		P05=ON_LEVEL
#define led_id2_set_port_off()		P05=OFF_LEVEL
...
#elif defined(ADKEY_GPIO_USE_P05)
#define ADC_CH_FOR_KEY		0xF5
...
#elif defined(BAT_AD_GPIO_USE_P04)
#define AD_CH_BAT_PORT		0xF4
...
#ifdef AD_MODE_GPIO_USE_P07
#define AD_CH_MODE_PORT		0xF7
#elif defined(AD_MODE_GPIO_USE_P06)
#define AD_CH_MODE_PORT		0xF6
#elif defined(AD_MODE_GPIO_USE_P05)
#define AD_CH_MODE_PORT		0xF5
#elif defined(AD_MODE_GPIO_USE_P02)
#define AD_CH_MODE_PORT		0xF2
#else
"ERROR : NO ADC KEY PORT DEFINE "
#endif
...
#define  charger_detect_gpio_release()      		P0DIR &= ~(BIT(CHGR_PORT_BIT)); //linein check port
#elif defined(CHARGER_DETECT_USE_P23)
#define  CHGR_PORT_BIT		3
#define  charger_detect_gpio_init()      			P2DIR &=~(BIT(1));P23=~(CHARGER_INVALID_LEVEL); P2DIR |= BIT(CHGR_PORT_BIT);P2PU &=~(BIT(CHGR_PORT_BIT));P2PD |=(BIT(CHGR_PORT_BIT))
#define  charger_detect_gpio_pin 		 		P23
#define  charger_detect_gpio_release()      		P2DIR &= ~(BIT(CHGR_PORT_BIT)); //linein check port
#else
"ERROR : NO   PORT DEFINE "
#endif
...
#define SET_IIC_CLK_OUT()	P0DIR &= ~(BIT(0));P0PU |= (BIT(0));	
...
#define SET_IIC_CLK_OUT()	P0DIR &= ~(BIT(1));P0PU |= (BIT(1));	
#define SET_IIC_DATA_OUT()	P0DIR &= ~(BIT(0));	
#define SET_IIC_DATA_IN()	P0DIR |=(BIT(0));	P0PU |= (BIT(0));
#elif defined(IIC_GPIO_CLK_DATA_USE_P01_P02)
...
#elif defined(IIC_GPIO_CLK_DATA_USE_P06_P35)

#define IIC_CLK_PIN			P06
#define IIC_DATA_PIN		P35
#define SET_IIC_CLK_OUT()	P0DIR &= ~(BIT(6));P0PU |= (BIT(6));	
#define SET_IIC_DATA_OUT()	P3DIR &= ~(BIT(5));	
#define SET_IIC_DATA_IN()	P3DIR |=(BIT(5));	P3PU |= (BIT(5));
...
#define BT_S_PORT_BIT		4
#define BLUE_TOOTH_STATUS_LED_INIT()		P4DIR &= ~BIT(BT_S_PORT_BIT);P4PU |= BIT(BT_S_PORT_BIT);P4 &=~(BIT(BT_S_PORT_BIT));
...
#define BT_PWR_PORT_BIT		6
#define BLUE_TOOTH_PWR_ON()		P1DIR &= ~BIT(BT_PWR_PORT_BIT);P1PU |= BIT(BT_PWR_PORT_BIT);P16 = 1
#define BLUE_TOOTH_PWR_OFF()		P1DIR &= ~BIT(BT_PWR_PORT_BIT);P1PU |= BIT(BT_PWR_PORT_BIT);P16 = 0
#elif defined(BLUE_TOOTH_GPIO_PWR_AT_DP_P36)
#define BT_PWR_PORT_BIT		6
#define BLUE_TOOTH_PWR_ON()		P3DIR &= ~BIT(BT_PWR_PORT_BIT);P3PU |= BIT(BT_PWR_PORT_BIT);P36 = 1
#define BLUE_TOOTH_PWR_OFF()		P3DIR &= ~BIT(BT_PWR_PORT_BIT);P3PU |= BIT(BT_PWR_PORT_BIT);P36 = 0
#elif defined(BLUE_TOOTH_GPIO_PWR_AT_DM_P37)
#define BT_PWR_PORT_BIT		7
#define BLUE_TOOTH_PWR_ON()		P3DIR &= ~BIT(BT_PWR_PORT_BIT);P3PU |= BIT(BT_PWR_PORT_BIT);P37 = 1
#define BLUE_TOOTH_PWR_OFF()		P3DIR &= ~BIT(BT_PWR_PORT_BIT);P3PU |= BIT(BT_PWR_PORT_BIT);P37 = 0
#elif defined(BLUE_TOOTH_GPIO_PWR_AT_P01)
#define BT_PWR_PORT_BIT		1
#define BLUE_TOOTH_PWR_ON()		P0DIR &= ~BIT(BT_PWR_PORT_BIT);P0PU |= BIT(BT_PWR_PORT_BIT);P01 = 1
#define BLUE_TOOTH_PWR_OFF()		P0DIR &= ~BIT(BT_PWR_PORT_BIT);P0PU |= BIT(BT_PWR_PORT_BIT);P01 = 0
#elif defined(BLUE_TOOTH_GPIO_PWR_AT_P46)
#define BT_PWR_PORT_BIT		6
#define BLUE_TOOTH_PWR_ON()		P4DIR &=~(BIT(BT_PWR_PORT_BIT));P4PU |= BIT(BT_PWR_PORT_BIT);P4|=(BIT(BT_PWR_PORT_BIT))
#define BLUE_TOOTH_PWR_OFF()		P4DIR &=~(BIT(BT_PWR_PORT_BIT));P4PU |= BIT(BT_PWR_PORT_BIT);P4&=~(BIT(BT_PWR_PORT_BIT))
#else
...
#ifdef BLUE_TOOTH_AUX_FUNC_GPIO_AT_DM_P37
...
#elif defined(BLUE_TOOTH_AUX_FUNC_GPIO_AT_DP_P36)
#define BT_AUX_PORT_BIT		6
#define BLUE_TOOTH_AUX_MODE()				P3DIR &= ~BIT(BT_AUX_PORT_BIT);P3PU |= BIT(BT_AUX_PORT_BIT);P36 = 0
#define BLUE_TOOTH_AUX_MODE_RELEASE()	P3DIR &= ~BIT(BT_AUX_PORT_BIT);P3PU |= BIT(BT_AUX_PORT_BIT);P36 = 1
#endif
...
#if defined(AMP_GPIO_POWER_CTRL_AT_P24)

#define AMP_WORK_LOGIC		1
#define AMP_DEAD_LOGIC		0

#define AMP_CTRL_PORT_BIT		4
#define AMP_CTRL_PORT			P24

#define AMP_TURN_ON_POWER()		P2DIR &= ~(BIT(AMP_CTRL_PORT_BIT));P2PU |= BIT(AMP_CTRL_PORT_BIT);AMP_CTRL_PORT = AMP_WORK_LOGIC
#define AMP_TURN_OFF_POWER()		P2DIR &= ~(BIT(AMP_CTRL_PORT_BIT));P2PU |= BIT(AMP_CTRL_PORT_BIT);AMP_CTRL_PORT = AMP_DEAD_LOGIC

#endif
#endif

#ifdef GPIO_BACKLIGHT_POWER_CTRL

#if defined(GPIO_BACKLIGHT_POWER_CTRL_AT_P34)

#define BL_WORK_LOGIC		0
#define BL_DEAD_LOGIC		1

#define GPIO_BL_CTRL_PORT_BIT		4
#define GPIO_BACKLIGHT_CTRL_PORT			P34

#define GPIO_BACKLIGHT_TURN_ON()		P3DIR &= ~(BIT(GPIO_BL_CTRL_PORT_BIT));P3PU |= BIT(GPIO_BL_CTRL_PORT_BIT);GPIO_BACKLIGHT_CTRL_PORT = BL_WORK_LOGIC
#define GPIO_BACKLIGHT_TURN_OFF()		P3DIR &= ~(BIT(GPIO_BL_CTRL_PORT_BIT));P3PU |= BIT(GPIO_BL_CTRL_PORT_BIT);GPIO_BACKLIGHT_CTRL_PORT = BL_DEAD_LOGIC
