...
#define IRFF00_MUSIC_SHORT		\
								...
								/*14*/    MSG_VOL_UP,\
								/*15*/    MSG_VOL_DOWN,\
								/*16*/    MSG_MUSIC_PREV_FILE,\
								/*17*/    MSG_MUSIC_NEXT_FILE,\
								/*18*/    MSG_MUSIC_NEXT_EQ,\
								/*19*/    NO_MSG,\
								/*20*/    NO_MSG,\
								/*21*/    MSG_NEXT_FOLDER,\
								/*22*/    MSG_PREV_FOLDER,\
								/*23*/    MSG_MUSIC_STOP,\
								/*24*/    MSG_REC_KEY_AT_SD,\
								/*25*/    MSG_DEL_CURR_FILE,\
								/*26*/    MSG_SYS_POWERON,\
								/*27*/    MSG_SLEEP_SETUP,\
								/*28*/    MSG_ALM_SETUP,\
								/*29*/    MSG_MUTE_UNMUTE
...
const u8 _code irff00_msg_music_table[4][30] =				//Music模式下的遥控转换表
{
...
const u8 _code irff00_msg_fm_table[4][30] =				//Music模式下的遥控转换表
{
    /*短按*/	    {IRFF00_FM_SHORT},
    /*长按*/		{IRFF00_FM_LONG},
    /*连按*/		{IRFF00_FM_HOLD},
