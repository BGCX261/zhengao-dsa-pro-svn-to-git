...
_near_func void LCD_clear_icon(u8 icon);
_near_func void LCD_show_icon(u8 icon);
_near_func void LCD_SEG5X9_show_Hi(void);
_near_func void LCD_backlight_turn_on(void);
_near_func void LCD_backlight_turn_off(void);
...
#define COM0_SEG00(x)	P0DIE = ((P0DIE & (~(BIT(7)|BIT(1)|BIT(0)))) | ((x & (BIT(7)|BIT(1)|BIT(0)))))
#define COM0_SEG01(x)	P1DIE = x

#define COM1_SEG00(x)	P0HD = ((P0HD & (~(BIT(7)|BIT(1)|BIT(0)))) | ((x & (BIT(7)|BIT(1)|BIT(0)))))
#define COM1_SEG01(x)	P1HD = x

#define COM2_SEG00(x)	P0PD =((P0PD & (~(BIT(7)|BIT(1)|BIT(0)))) | ((x & (BIT(7)|BIT(1)|BIT(0)))))
#define COM2_SEG01(x)	P1PD = x

#define COM3_SEG00(x)	P0PU = ((P0PU & (~(BIT(7)|BIT(1)|BIT(0)))) | ((x & (BIT(7)|BIT(1)|BIT(0)))))
#define COM3_SEG01(x)	P1PU = x

#define COM4_SEG00(x)	P0 = ((P0 & (~(BIT(7)|BIT(1)|BIT(0)))) | ((x & (BIT(7)|BIT(1)|BIT(0)))))
#define COM4_SEG01(x)	P1 = x

#define COM5_SEG00(x)	P0DIR = ((P0DIR & (~(BIT(7)|BIT(1)|BIT(0)))) | ((x & (BIT(7)|BIT(1)|BIT(0)))))
...
#define PLAY_ICON	BIT(0)
#define PAUS_ICON	BIT(0)
#define SD_ICON	    	BIT(7)
#define SD_ICON	    	BIT(7)
#define USB_ICON	BIT(7)
#define COL_ICON	BIT(7)
#define REP_ICON	BIT(2)
#define FM_ICON	    	BIT(1)
#define AM_ICON	    	BIT(1)
#define ONE_ICON	BIT(1)
#define MHZ_ICON	BIT(5)|BIT(3)
#define KHZ_ICON	BIT(1)
#define AUX_ICON	BIT(3)
#define PC_ICON		BIT(1)


#define BAT_SHELL_ICON		BIT(0)
#define BAT_LVL1_ICON		BIT(0)
#define BAT_LVL2_ICON		BIT(7)
