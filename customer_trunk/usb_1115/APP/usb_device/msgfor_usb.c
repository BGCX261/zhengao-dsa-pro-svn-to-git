...
extern void write_hprc_cnt(u8 mem_correct_cnt, u8 *memery_hprc_counter);
u8 _xdata USB_Mic_buffer[1024] _at_ 0x700;	   ///<DAC缓存BUFF
u8 _xdata desc_buf[512] _at_ 0x1000;           ///<枚举数组
